...
function pendrell_header_skip_to_content( $buttons ) {
  echo '<div class="buttons"><a href="#content" class="button skip-link" role="button" rel="nofollow">' . __( 'Skip to content', 'pendrell' ) . '</a></div>';
}
...
function pendrell_header_responsive_menu() {
  echo '<div class="buttons"><button id="menu-toggle" class="menu-toggle">' . pendrell_icon_text( 'menu-toggle', __( 'Menu', 'pendrell' ) ) . '</button></div>';
}
...
add_action( 'pendrell_header_navigation', 'pendrell_header_search', 5 );
...
function pendrell_footer_skip_to_top() {
  echo '<div class="buttons"><a href="#page" class="button skip-top" rel="nofollow" role="button">' . pendrell_icon_text( 'top-link', __( 'Top', 'pendrell' ) ) . '</a></div>';
}
