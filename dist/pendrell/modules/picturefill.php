...
if ( !function_exists( 'pendrell_sizes_media_queries' ) ) : function pendrell_sizes_media_queries( $queries ) {
  ...
  // Flush the array? The order of the `sizes` attributes matters but this prevents us from hooking the same filter elsewhere
  $queries = array();
  ...
  // @TODO: handle half/third/quarter width images and similar layouts
